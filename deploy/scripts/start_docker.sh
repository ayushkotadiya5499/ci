...
docker pull 982534348859.dkr.ecr.us-east-1.amazonaws.com/salary_ecr:front_change
...
docker run -d -p 80:8501 --name salary-app 982534348859.dkr.ecr.us-east-1.amazonaws.com/salary_ecr:front_change